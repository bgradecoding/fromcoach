...
- Added `docs/DEMO_VIDEO_SCRIPT.md`: a 2:45 Korean read-aloud narration, shot timeline, exact Korean agent prompts/tool arguments, camera framing, English-subtitle guidance, and clearly labelled synthetic-replay rehearsal. Updated README and Devpost text to reflect implemented behavior and official submission requirements.
...
- Filming revision: switched the main demo and its E2E rehearsal from squat to pushup, updated pushup camera framing, and changed all copy-and-paste LLM prompts to English. The focused Playwright demo flow passed with `pushup_5reps_side` (two sets/five reps).
